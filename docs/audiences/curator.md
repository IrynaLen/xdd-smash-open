...
- A way to transform the request into [ctx](../framework.md), which every hook receives
- Requests that already pass through your own infrastructure
- A store to read segment or signal state from, if your rules need one
